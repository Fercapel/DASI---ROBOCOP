...
public class ControladorEditorEntornosSimulacion {
	...
	public  void peticionAbrirEscenario() {
		...
		if (ficheroSeleccionado==null)visorEditorEscen.visualizarConsejo(tituloAvisoEscenarioNoDefinido, mensajeEscenarioNoSeleccionado,recomendacionDefinirEscenario);
			...
			identsRobotsEquipo=escenarioActualComp.getListIdentsPolicias();
	...
	void peticionGuardarEscenario() {
		...
		if (escenarioActualComp.getNumPolicias()<=0)visorEditorEscen.visualizarConsejo(tituloAvisoEscenSinRobotsDefinidos, mensajeEscenarioSinRobots, recomendacionDefinirRobots);
		else{
	...
	EscenarioSimulacionPoliciasLadrones dameEscenario(String identEscenario) {
		//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
